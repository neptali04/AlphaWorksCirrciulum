...
<!-- end about -->
   ...
   <div class="content">
      ...
      <div class="card">
            ...
            <div class="icon"><i class="fa-solid fa-envelope fa-3x"></i></div>
      ...
      <div class="card">
            ...
            <div class="icon"><i class="fa-solid fa-people-group fa-3x"></i></div>
      ...
      <div class="card">
            ...
            <div class="icon"><i class="fa-solid fa-seedling fa-3x"></i></div>
